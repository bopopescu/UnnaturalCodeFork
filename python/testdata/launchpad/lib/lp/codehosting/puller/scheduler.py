...
class PullerMonitorProtocol(ProcessMonitorProtocolWithTimeout,
    ...
    def __init__(self, deferred, listener, clock=None):
        ...
        :param listener: A PullerMain object that is notified when the
...
class PullerMain:
    ...
    The `PullerMain` kicks off a child worker process and handles the events
...
class LockError(StandardError):
    ...
    def __str__(self):
        return 'Jobmanager unable to get main lock: %s' % self.lockfilename
